            ...
            <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="header_title" name="header_title" placeholder="Enter English Header Title" autocomplete="off">
                    </div>

                    {{-- Header title arabic --}}
                    <div class="form-group">
                      <label for="header_title_ar">Arabic Header Title</label>
                      <input type="text" class="form-control" id="header_title_ar" name="header_title_ar" placeholder="Enter Arabic Header Title" autocomplete="off">
                    </div>
                    ...
                    <div class="form-group mt-5">
                      ...
                      <input type="text" class="form-control" id="post_title" name="post_title" placeholder="Enter English Post Title" autocomplete="off">
                    </div>

                    {{-- Post title arabic --}}
                    <div class="form-group">
                      <label for="post_title_ar">Arabic Post Title</label>
                      <input type="text" class="form-control" id="post_title_ar" name="post_title_ar" placeholder="Enter Arabic Post Title" autocomplete="off">
                    </div>
                ...
                <div class="row mt-3">
                  <div class="col-md-12">
                      <div class="card card-outline card-info">
                          <div class="card-header">
                              <h3 class="card-title">
                              Write Arabic Post Body
                              </h3>
                          </div>
                          <!-- /.card-header -->
                          <div class="card-body">
                              <textarea id="summernote2" name="post_body_ar"></textarea>
                          </div>
                      </div>
                  </div>
                  <!-- /.col-->

            ...
            <form action="{{ route('section.update',$section->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="section_name" name="section_name" placeholder="Enter Section Name" autocomplete="off" value="{{ $section->section_name }}">
                    </div>

                    {{--  Section Name Arabic --}}
                    <div class="form-group">
                      <label for="section_name_ar">Arabic Section Name </label>
                      <input type="text" class="form-control" id="section_name_ar" name="section_name_ar" placeholder="Enter Aracic Section Name" autocomplete="off" value="{{ $section->section_name_ar }}">
                  </div>
              </div>
              <!-- /.card-body -->

            ...
            <form action="{{ route('home-slider.update',$slider->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="slider_title" name="slider_title" placeholder="Enter Slider Title" autocomplete="off" value="{{ $slider->slider_title }}">
                </div>
                {{-- slider title arabic --}}
                <div class="form-group">
                  <label for="slider_title_ar">Arabic Slider Title</label><span class="text-danger" >  *</span>
                  <input type="text" class="form-control" id="slider_title_ar" name="slider_title_ar" placeholder="Enter Arabic Slider Title" autocomplete="off" value="{{ $slider->slider_title_ar }}">
                </div>

                {{-- slider subtitle --}}
                <div class="form-group">
                  <label for="slider_subtitle">English Slider Subtitle</label><span class="text-danger" >  *</span>
                  <input type="text" class="form-control" id="slider_subtitle" name="slider_subtitle" placeholder="Enter Slider Subtitle" autocomplete="off" value="{{ $slider->slider_subtitle }}">
                </div>
                {{-- slider subtitle arabic--}}
                <div class="form-group">
                  <label for="slider_subtitle_ar">Arabic Slider Subtitle</label><span class="text-danger" >  *</span>
                  <input type="text" class="form-control" id="slider_subtitle_ar" name="slider_subtitle_ar" placeholder="Enter Arabic Slider Subtitle" autocomplete="off" value="{{ $slider->slider_subtitle_ar }}">
                </div>

                {{-- slider btn name--}}
                <div class="form-group mt-5">
                  <label for="btn_name">English Button Name</label><span class="text-danger" >  *</span>
                  <input type="text" class="form-control" id="btn_name" name="btn_name" placeholder="Enter Button Name" autocomplete="off" value="{{ $slider->btn_name }}">
                </div>
                {{-- slider btn name arabic--}}
                <div class="form-group">
                  <label for="btn_name_ar">Arabic Button Name</label><span class="text-danger" >  *</span>
                  <input type="text" class="form-control" id="btn_name_ar" name="btn_name_ar" placeholder="Enter Arabic Button Name" autocomplete="off" value="{{ $slider->btn_name_ar }}">
                </div>
                ...
                <div class="form-group mt-5">
                  ...
                  <input type="text" class="form-control" id="btn_link" name="btn_link" placeholder="Enter Button Link" autocomplete="off" value="{{ $slider->btn_link }}">
                </div>
                ...
                <div class="form-group ">
                  ...
                  <select class="select2"  style="width: 100%;" name="post_id">
                      <option value="" disabled >Select Post To Redirect To</option>
                      @foreach ($posts as $post)
                          <option value="{{ $post->id }}" {{ $post->id == $slider->post_id ? "selected" : " " }}>{{ $post->post_title }}
                          </option>
                      @endforeach
                  </select>
                </div>
                ...
                <div class="form-group mt-5">
                  ...
                  <div class="form-group mt-2">
                    <img id="backGround_output" src="{{ asset($slider->slider_image) }}" alt="" style="width: 500px; height:400px;">
                  </div>
                </div>
            </div>
